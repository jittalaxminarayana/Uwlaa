    ...
    return (
        <View style={{ flex: 1, marginTop: 30, paddingHorizontal: 20 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                <Text style={{ fontSize: 18, fontWeight: 'bold', marginLeft: 10, marginTop: 10, color: 'black' }}>Movers</Text>
                <Text style={{ fontWeight: 'bold', marginRight: 10 }}>18</Text>
            </View>
            <FlatList
                data={vehicleData}
